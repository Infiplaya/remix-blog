  ...
  return (
    <div className="flex justify-center items-center text-center text-4xl px-6 h-screen">
      <div className="flex flex-col gap-5">
        <h1 className="font-bold lg:text-6xl">Hello, im <span className="text-indigo-400">Paweł</span>!</h1>
        ...
        <ul className="flex gap-3 mt-10 text-lg self-center">
          <a href={"https://portfolio-six-gamma-90.vercel.app/"}>
          ...
          <a href={"https://www.linkedin.com/in/psobaniec09/"}>
            <li className="text-indigo-600 hover:text-indigo-700">Linkedin</li>
          </a>
        </ul>
      </div>
    </div>
